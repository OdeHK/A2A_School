...
class DatabaseService:
    ...
    def create_user(self, username: str, password: str, email: str = None, full_name: str = None) -> tuple[bool, str]:
        """
        Create a new user in the database.
        
        Args:
            username: Unique username
            password: User password (will be stored as-is, consider hashing in production)
        ...
        try:
            ...
            if self.check_user_exists(username=username, email=email):
                return False, "Username hoặc email đã tồn tại"
            
            # Create user document
            user_doc = {
                "username": username,
                "password": password,  # TODO: Add password hashing with bcrypt
