...
def get_quiz_generation_prompt() -> ChatPromptTemplate:
    ...
    return ChatPromptTemplate.from_messages([
        SystemMessagePromptTemplate.from_template(
            ...
            "However, the retrieved context may contain some errors because it is extracted automatically. Therefore, you need to be careful to avoid including any incorrect information in the questions."
        ...
        HumanMessagePromptTemplate.from_template(
            ...
            "However, the retrieved context may contain some errors because it is extracted automatically. Therefore, you need to be careful to avoid including any incorrect information in the questions."
            "# TASK: "
            "Generate a set of questions in accordance with the above instructions. Note that strict adherence to the specified output formatting guidelines is absolutely critical and non-negotiable."
        )])
